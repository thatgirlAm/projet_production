...
function include_header(){
    ?>
    <div class="header">
            <img src="https://devweb.estia.fr/tai/tai_crocodile/project/MVC/public/assets/images/logo.png" class="logo" alt="logo">
                ...
                ?><div class="userInfos">
                <?php echo "<div class = messageUser>"."<div>".$message."</div><div> Fonction : ".$service."</div></div>";?>
            </div>
...
{
    header("Location: " .'https://devweb.estia.fr/tai/tai_crocodile/project/'.$path);
	die;
}
